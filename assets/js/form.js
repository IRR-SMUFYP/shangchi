...
async function getCatalog() {
    let response = await fetch("http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/getCatalog")
...
async function populateSubCat(cat) {
    $('#subCatOptions').html("")
    cat = cat.value
    let response = await fetch("http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/getSubCat/" + cat)
    let responseCode = await response.json()
...
async function populateItemNames(cat) {
    $('#itemNameOptions').html("")
    cat = cat.value
    let response = await fetch("http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/getItemsInSubCat/" + cat)
    let responseCode = await response.json()
    if (responseCode.code == 200) {
...
async function addField(formName, fieldID = "") {
    ...
    var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/formbuilder" + fieldID;

...
async function getDropDownCat() {
    let response = await fetch("http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/getCat")
...
async function retrieveFormAdmin(formName) {
    ...
    if (formName == "request") {
        ...
        var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/formbuilder/" + formName;
...
function addRow(formName) {
    ...
    if (formName == "request") {
        var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/request";
    }
    else if (formName == "successfulMatch") {
        var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/addMatch";
    }
    else if (formName == "account") {
        var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/addUser"
    }
    else if (formName == "deliveryRequest") {
        var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/addDeliveryRequest"
    }
    $(async () => {
        try {
            const response =
...
function confirmDeleteRow(id) {
    $(async () => {
        ...
        if (id == "reqID") {
            var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/deleteRequest/" + val;
        }
        else if (id == "matchID") {
            var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/deleteMatch/" + val;
        }
        else if (id == "matchID (delivery)") {
            var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/deleteDeliveryRequest/" + val;
        }
        else {
            var serviceURL = "http://http://ec2-13-250-122-219.ap-southeast-1.compute.amazonaws.com/:5003/deleteRow/" + formName + "/" + val;
        }
        try {
            const response =
            await fetch(
